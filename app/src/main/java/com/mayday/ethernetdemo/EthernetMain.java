    ...
    public void staticEth(String ip, String fix, String dns1,String dns2, String gw) {
        if (ethernetManager.getEthernetIfaceState() != ethernetManager.ETHER_IFACE_STATE_UP) {
            ...
            if (isIpAddress(ip)) {
                ...
                String staticIP = Settings.System.getString(contentResolver, Settings.System.ETHERNET_STATIC_IP);
                String netMask = Settings.System.getString(contentResolver, Settings.System.ETHERNET_STATIC_NETMASK);
                String staticDNS1 = Settings.System.getString(contentResolver, Settings.System.ETHERNET_STATIC_DNS1);
                String staticDNS2 = Settings.System.getString(contentResolver, Settings.System.ETHERNET_STATIC_DNS2);
                String gateway = Settings.System.getString(contentResolver, Settings.System.ETHERNET_STATIC_GATEWAY);
